...
@Getter
public class DiscountStoreDetailDto {
    ...
    public static DiscountStoreDetailDto of(Store store, List<ProductDto> products) {
        return new DiscountStoreDetailDto(store, products);
    }
}
